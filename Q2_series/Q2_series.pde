...
void setup() {
  ...
  w3 = new RObj(w2.endX, w2.endY, L2/2, deg, w2.Vout, V2, "L");                //
  w4 = new RObj(w3.endX, w3.endY, L2/2, deg, w3.Vout, Gnd, "L");                //
  w5 = new WireObj(w4.endX, w4.endY, L1, deg, Gnd, Gnd, "D");                    //
  //********************************************この部分を編集//***********************
}
...
//************************************************************  //スライダーで接続する電圧を設定
  ...
  w2.Vin =  sliderValue;
  w3.Vin = sliderValue;
    w3.Vout = sliderValue/2;
  w4.Vin = sliderValue/2;
