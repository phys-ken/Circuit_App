...
void setup() {
  ...
  float Gnd  = 0;                                                                 //
                                                                                  //
 w0 = new BatObj(x1,y1,L1, deg , Gnd , Vin /2, "R") ;                                                                         
  w1 = new BatObj(w0.endX, w0.endY, L1, deg, w0.Vout, Vin, "R");                                //
  w2 = new WireObj(w1.endX, w1.endY, L1, deg, w1.Vout, w1.Vout, "U");             //
  w3 = new WireObj(w2.endX, w2.endY, L1, deg, w2.Vout, w2.Vout, "U");                //
  w4 = new RObj(w2.endX, w2.endY, L1, deg, w2.Vout, V2, "L");                //
  w5 = new RObj(w3.endX, w3.endY, L1, deg, w3.Vout, V2, "L");                    //
  w6 = new WireObj(w5.endX, w5.endY, L1, deg, w5.Vout, w5.Vout, "D");                //
  w7 = new RObj(w6.endX, w6.endY, L1, deg, w5.Vout, Gnd, "L"); 
  w8 = new WireObj(w7.endX, w7.endY, L1, deg, Gnd, Gnd, "D"); 
  //********************************************この部分を編集//***********************
}
...
//************************************************************  //スライダーで接続する電圧を設定
 w0.Vout = sliderValue / 2;
 w1.Vin = sliderValue /2;
  w1.Vout = sliderValue;
  w2.Vin =  sliderValue;
  w3.Vin = sliderValue;
    w4.Vin = sliderValue;
  w5.Vin = sliderValue;
    w4.Vout = sliderValue*2/3;
  w5.Vout = sliderValue*2/3;
w6.Vin = sliderValue*2/3;
w7.Vin = sliderValue*2/3;
