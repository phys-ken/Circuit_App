...
void setup() {
  ...
  float Gnd  = 0;                                                                 //
                                                                                  //
 w0 = new BatObj(x1,y1,0, deg , Gnd , Vin /2, "R") ;                                                                         
  w1 = new BatObj(w0.endX, w0.endY, L1, deg, w0.Vout, Vin, "D");                                //
  ...
  w5 = new RObj(w3.endX, w3.endY, L1, deg, w3.Vout, V2, "D");                    //
  w6 = new WireObj(w5.endX, w5.endY, L1, deg, w5.Vout, w5.Vout, "D");                //
  w7 = new RObj(w6.endX, w6.endY, L1, deg, w5.Vout, Gnd, "R"); 
